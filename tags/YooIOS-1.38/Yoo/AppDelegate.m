...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [UITools forceAudioComeFromSpeaker];
   // [self performSelector:@selector(initData) onThread:[NSThread mainThread] withObject:nil waitUntilDone:YES];
...
//    [userDefaults setObject:@"manuel" forKey:@"login"];
//    [userDefaults setObject:@"be6dpdxrz8" forKey:@"password"];
//    [userDefaults setObject:@"Manuel Kanka" forKey:@"nickname"];
...
//    [userDefaults setObject:@"855" forKey:@"callingCode"];
