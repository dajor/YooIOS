...
//    __weak typeof(YooMessage) *weakMessage = message;
//    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_HIGH, 0), ^{
//        typeof(YooMessage) *strongMessage = weakMessage;
//        [ChatDAO markAsReadByOther:[self getMyJid] ident:strongMessage.ident];
//    });
}
