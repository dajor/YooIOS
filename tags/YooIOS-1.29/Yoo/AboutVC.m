...
- (void)loadView {
    ...
    UILabel *versionLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, 204, size.width, 24)];
    ...
    UILabel *fellowLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, 224, size.width, 24)];
    ...
    //[fellowLbl setBackgroundColor:[UIColor redColor]];
