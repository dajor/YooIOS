...
- (id)init
{
    self = [super initWithTitle:NSLocalizedString(@"SELECT_BACKGROUND", nil)];
    return self;
}
...
- (void)loadView {
    ...
    UICollectionView *cv = [[UICollectionView alloc] initWithFrame:[self contentRect] collectionViewLayout:layout];
    [cv setAutoresizingMask:UIViewAutoresizingFlexibleHeight|UIViewAutoresizingFlexibleWidth];
