...
- (void)mustSend:(DDXMLElement *)element {
    ...
    if (networkStatus != NotReachable && self.xmppStream != nil && [self.xmppStream isConnected] && [self.xmppStream isAuthenticated]) {
...
- (void)xmppStream:(XMPPStream *)sender didReceiveMessage:(XMPPMessage *)message {
    ...
    if (yooMsg.type != ymtAck && yooMsg.type != ymtInvite && yooMsg.type != ymtRevoke) {
        ...
        //if( [self canalert:yooMsg])  [[ChatTools sharedInstance] playSound:yooMsg.type == ymtCallRequest?YES:NO];
