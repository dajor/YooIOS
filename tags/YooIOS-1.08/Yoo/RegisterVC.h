...
@interface RegisterVC : UITableViewController<UITableViewDataSource, UITableViewDelegate, LocationListener, PicklistListener, ChatListener, UITextFieldDelegate, FacebookListener>
