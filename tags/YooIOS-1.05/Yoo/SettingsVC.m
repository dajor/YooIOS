...
- (id)init {
    ...
    [self.navigationItem setRightBarButtonItem:[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"ABOUT_APP", nil) style:UIBarButtonItemStylePlain target:self action:@selector(showAbout)]];
