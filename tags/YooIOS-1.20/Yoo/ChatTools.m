...
- (void)showCallPopup:(CallInfo *)info {
    ...
    NSString *message = [NSString stringWithFormat:NSLocalizedString(@"CALL_FROM", nil), user.alias];
    UICustomAlertViewVC *alert = [[UICustomAlertViewVC alloc] initWithTitle:nil message:message delegate:self cancelButtonTitle:NSLocalizedString(@"CALL_DECLINE", nil) otherButtonTitles:NSLocalizedString(@"CALL_ACCEPT", nil), nil];
    alert.callInfo = info;
    [alert show];
...
- (void)answerCall:(CallInfo *)call accept:(BOOL)accept {
    ...
    [ChatDAO updateCall:call.caller ident:call.callMsgId accepted:accept];
