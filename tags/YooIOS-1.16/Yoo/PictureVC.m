...
- (void)loadView {
    ...
    [self.saveImageBtn setTitle:@"Save" forState:UIControlStateNormal];
...
-(void) saveImage:(id)sender
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"" message:@"Image is saved." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
    [alert show];
}
