...
- (void)layoutSubviews {
    ...
    self.textLabel.frame = CGRectMake(self.textLabel.frame.origin.x, self.textLabel.frame.origin.y, self.frame.size.width*0.5, self.textLabel.frame.size.height);
    self.detailTextLabel.frame = CGRectMake(self.detailTextLabel.frame.origin.x, self.detailTextLabel.frame.origin.y, self.frame.size.width*0.5, self.detailTextLabel.frame.size.height);
    
    
    self.dateTime.frame = CGRectMake(self.frame.size.width-150, self.frame.size.height-20, 100, 20);
