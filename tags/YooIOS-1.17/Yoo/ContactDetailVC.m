...
- (void)loadView {
    ...
    CGFloat width = image.size.width * 120 / image.size.height;
    [picture setFrame:CGRectMake((self.view.frame.size.width - width) / 2, y + 8, width, 120)];
