...
- (void)buildTitle {
    ...
    for (int i = 0; i < 3; i++) {
        UIView *stepView = [[UIView alloc] initWithFrame:CGRectMake(self.titleView.frame.size.width - 50 + i * 14, 18, 10, 10)];
        [stepView setAutoresizingMask:UIViewAutoresizingFlexibleLeftMargin];
        ...
        stepView.tag = 100 + i;
        [self.titleView addSubview:stepView];
    }
