...
- (void)requestCall:(NSArray *)pMembers listener:(NSObject<CallingListener> *)listener {
    ...
    for(YooUser *user in pMembers){
        ...
        names = [self toJSonStringWithKeysAndValues:@"Name", user.toJID, nil];
    }
    NSUserDefaults *userdefault = [NSUserDefaults standardUserDefaults];
    NSString *pName = [NSString stringWithFormat:@"%@@%@", [userdefault objectForKey:@"login"], YOO_DOMAIN] ;
    NSString *jsonData = [self toJSonStringWithKeyAndValueObject:@"Invitees" valueObject:[NSString stringWithFormat:@"[%@]", names] keysAndValues:@"Name", pName, nil];
...
- (void)sendMessage:(YooMessage *)yooMsg {
    ...
    NSXMLNode *textNode = [NSXMLNode textWithStringValue:yooMsg.message == nil ? @" " : [XMLTools escapeEmoji:yooMsg.message]];
