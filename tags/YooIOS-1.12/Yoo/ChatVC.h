...
@interface ChatVC : BaseVC<ChatListener, UITextViewDelegate, UIActionSheetDelegate, PicklistListener, ImageListListener, LocationListListener, MKMapViewDelegate, RecordListener, AVAudioPlayerDelegate, CallingListener, UIAlertViewDelegate>
