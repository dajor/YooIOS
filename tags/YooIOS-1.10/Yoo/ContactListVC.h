...
@interface ContactListVC : UIViewController<UITableViewDataSource, UITableViewDelegate, ChatListener, UISearchDisplayDelegate, UISearchBarDelegate, ContactListener>
