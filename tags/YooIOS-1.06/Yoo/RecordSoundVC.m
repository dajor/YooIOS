...
- (id)initWithListener:(NSObject <RecordListener> *)pListener
{
    ...
    if (self) {
        ...
        self.title = NSLocalizedString(@"RECORD_MESSAGE", nil);
        [self.navigationItem setLeftBarButtonItem:[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(cancel)]];
        [self.navigationItem setRightBarButtonItem:[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(send)]];
